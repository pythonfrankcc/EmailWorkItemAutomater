...
#In the case when one may want to change the theme color of the window
#window.config(bg="black")
window.title("Pin Your Pending Item")

title_label = Label(window, text="Pin Your Pending Item").pack()
#Read inputs
#Date input
